...
float ModeAcro_Rate::throttle_hover() const
{
...
void ModeAcro_Rate::get_pilot_desired_angle_rates(int16_t roll_in, int16_t pitch_in, int16_t yaw_in, float &roll_out, float &pitch_out, float &yaw_out)
{
    float rate_limit;
    ...
    attitude_control->get_rollrate(roll_out);
    attitude_control->get_pitchrate(pitch_out);
    attitude_control->get_yawrate(yaw_out);
